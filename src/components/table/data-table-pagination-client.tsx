...
export default function DataTablePaginationClient<TData>({ table, attribute, setAttribute }: TablePaginationProps<TData>) {
    ...
    return (
        <div className="mt-2 flex flex-col justify-end gap-2 lg:flex-row lg:items-center">
            <div className="flex-1 text-left text-xs text-gray-600">
                Showing {show} to {to} of {attribute?.total_items} results
            </div>
            <div className="flex items-center space-x-6 lg:space-x-8">
                ...
                <div className="flex flex-col lg:flex-row">
                    <div className="flex w-[100px] items-center justify-center text-sm">
                        Page {+attribute.page + 1} of {table.getPageCount()}
                    </div>
